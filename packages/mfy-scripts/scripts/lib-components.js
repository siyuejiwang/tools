/**
 * @description build gw-web-components project
 */
const chalk = require("chalk");
const webpack = require("webpack");
const getConfig = require("../config/webpack.components.config");
const { changeCommands } = require("./gulp-helper");
const commander = require("../bin/commanders/lib-components");
